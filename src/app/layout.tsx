...
const jsonLd = [
  ...
  },
  {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Cheap Netflix Subscription", offers: { "@type": "Offer", priceCurrency: "USD", price: "1.00", availability: "https://schema.org/InStock" } } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Cheap Spotify Premium", offers: { "@type": "Offer", priceCurrency: "USD", price: "1.00", availability: "https://schema.org/InStock" } } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Affordable IPTV", offers: { "@type": "Offer", priceCurrency: "USD", price: "1.00", availability: "https://schema.org/InStock" } } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "AI Tools", offers: { "@type": "Offer", priceCurrency: "USD", price: "1.00", availability: "https://schema.org/InStock" } } },
        { "@type": "Offer", itemOffered: { "@type": "Product", name: "Gaming Keys", offers: { "@type": "Offer", priceCurrency: "USD", price: "1.00", availability: "https://schema.org/InStock" } } },
      ],
    },
  },
];

    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">
          Earn Money by Sharing <span style={{ background: "linear-gradient(135deg, #a78bfa, #7c3aed)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Velxo</span>
        </h1>
        ...
        <Link href="/auth/register" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-white text-base"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-16">
        {[
          ...
          <div key={stat.label} className="rounded-xl border border-white/8 bg-[#111111] p-5 text-center">
            <div className="text-2xl font-bold mb-1" style={{ background: "linear-gradient(135deg, #a78bfa, #7c3aed)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
              {stat.value}
            </div>
      ...
      <div className="rounded-xl border border-white/8 bg-[#111111] p-8 mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            { icon: Share2, text: "Unique velxo.shop/ref/[code] link for each affiliate" },
      ...
      <div className="text-center">
        <Link href="/auth/register" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold text-white"
          style={{ background: "linear-gradient(135deg, #7c3aed, #8b5cf6)" }}>
          Start Earning Today <ArrowRight size={18} />
        </Link>
        <p className="text-xs text-gray-600 mt-3">Already have an account? <Link href="/dashboard" className="text-purple-400 hover:text-purple-300">Go to Dashboard</Link></p>
      </div>
    </div>
  );
}

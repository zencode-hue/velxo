    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">
          ...
          <span style={{ background: "linear-gradient(135deg, #fbbf24, #ea580c)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
            Velxo
          </span>
        </h1>
        ...
        <Link href="/auth/register"
          ...
          style={{ background: "linear-gradient(135deg, #ea580c, #f97316)", boxShadow: "0 4px 20px rgba(124,58,237,0.4)" }}>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <div key={item.step} className="rounded-xl border border-white/8 bg-[#1a1208] p-6 text-center">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-16">
        {[
          ...
          <div key={stat.label} className="rounded-xl border border-white/8 bg-[#1a1208] p-5 text-center">
      ...
      <div className="rounded-xl border border-white/8 bg-[#1a1208] p-8 mb-12">

...
export const metadata: Metadata = { title: "Privacy Policy — MetraMart", description: "Read the privacy policy for MetraMart. We protect your data." };
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="space-y-8 text-gray-400 text-sm leading-relaxed">
        {[
          ...
          { title: "6. Your Rights", body: "You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at support@metramart.xyz. We will respond within 30 days." },
          ...
          { title: "8. Contact", body: "For privacy questions, contact us at privacy@metramart.xyz or via our Discord server." },
        ].map((section) => (

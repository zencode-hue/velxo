...
const faqs = [
  ...
  { q: "What is the wallet balance?", a: "Your wallet balance can be used to purchase any product instantly without going through a payment gateway. Top up via crypto or Discord." },
  ...
  { q: "How do I become an admin?", a: "Admin access is granted manually. Contact us on Discord if you're interested in partnership opportunities." },
];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
        <a href={process.env.NEXT_PUBLIC_DISCORD_URL ?? "https://discord.gg/velxo"}
      ...
      <div className="rounded-xl border border-purple-600/20 bg-purple-600/5 p-8 text-center">
        ...
        <Link href="https://discord.gg/velxo" target="_blank"

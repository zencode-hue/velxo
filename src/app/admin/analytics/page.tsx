...
import { BarChart2, Globe, Monitor, Smartphone, Chrome, MapPin, Link2, Eye, Users, TrendingUp } from "lucide-react";
          ...
          <tbody>
            {(recentViews as { path: string; country: string | null; device: string | null; browser: string | null; referrer: string | null; ip: string | null; createdAt: Date }[]).map((v, i) => (
              <tr key={i} className="border-b border-white/5 hover:bg-white/2">
                ...
                <td className="px-5 py-2.5 text-gray-500 truncate max-w-[120px]">{v.referrer ? new URL(v.referrer).hostname : "direct"}</td>
